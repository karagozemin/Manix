  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <div className="p-1.5 bg-[#00D9A5]/10 rounded-lg">
          <Blocks className="w-3.5 h-3.5 text-[#00D9A5]" />
        </div>
      ...
      <div className="text-right">
        ...
        <div className="text-xs font-mono text-[#00B894]">{block.txCount} txs</div>
      </div>
    </motion.div>
  );
}
...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#0a0f0d] text-white selection:bg-[#00D9A5]/30 overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            ...
            <div className="glass-panel rounded-xl p-3 col-span-2 h-[180px]">
              <div className="flex justify-between items-center mb-2">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[10px] text-[#00D9A5] font-bold">Live from Mantle</span>
                </div>
              </div>
            ...
            <div className="glass-panel rounded-xl p-3 col-span-2 grid grid-cols-2 gap-3">
              ...
              <div className="border-l border-white/10 pl-4">
                ...
                <motion.div 
                  ...
                  initial={{ opacity: 0.5 }}
                  animate={{ opacity: 1 }}
                  className="text-xl font-mono font-bold text-[#00B894]"
                >
                  {isLoading ? "..." : parseFloat(stats.gasPrice).toFixed(4)} 
                  <span className="text-xs text-gray-500 font-sans ml-1">Gwei</span>
                </motion.div>
                <div className="h-1 w-full bg-[#00B894]/20 mt-2 rounded-full overflow-hidden">
                  <motion.div 
            ...
            <div className="glass-panel rounded-xl p-3 col-span-2 grid grid-cols-2 gap-2">
              ...
              <div className="bg-white/5 rounded-lg p-3 flex flex-col justify-center items-center">
                ...
                <span className="text-xl font-mono font-bold text-[#00B894]">L2</span>
